...
TYPES = {'firefox': webdriver.Firefox, 'chrome': webdriver.Chrome,
         'ie': webdriver.Ie, 'phantomsjs': webdriver.PhantomJS}
EXECUTABLE_PATH = {'firefox': 'wires', 'chrome': CHROMEDRIVER_PATH,
                   'ie': IEDRIVER_PATH, 'phantomjs': PHANTOMJSDRIVER_PATH}
...
class Brower(object):
    def __init__(self, brower_type='firefox'):
        self._type = brower_type.lower()
